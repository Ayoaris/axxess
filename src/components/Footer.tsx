...
function Footer() {
  return (
    <footer className="px-7 lg:px-20 py-5 bg-[#1e1e1e]">
      <div className="flex flex-col gap-8">
        <p className="flex flex-wrap gap-4 text-[#babfc3] text-sm">
          <span>Home</span>
          <span>|</span>
        ...
        <p className="text-[#babfc3] text-xs leading-[14.09px]">
          Copyright © 2016 DEMO Streaming. All Rights Reserved.
        </p>
      </div>

      <div className="w-full flex flex-col lg:flex-row gap-8 lg:justify-between lg:items-center">
        <div className="mt-10 pb-7 flex flex-wrap gap-4">
          <svg
